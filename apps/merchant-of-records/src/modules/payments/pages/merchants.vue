    ...
    <PageContentWrapper>
      <template v-slot:pageOptions>
        <div class="button-row">
          <router-link to = "/merchant/add" class="!h-12 btn btn-primary">Add new merchant</router-link>
        </div>
      </template>
      ...
      <template v-slot:pageContent>
        <TableContainer
          ...
          :emptyData="{
            ...
            description:
              'You can start by adding a new merchant.',
          }"
        >
          <TableContainerBody
            ...
            :tableHeader="tableHeader"
            :tableData="payload"
            :onTableClicked="handleTableClicked"
          />
        </TableContainer>
      </template>
    </PageContentWrapper>
