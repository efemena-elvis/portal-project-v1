...
<template #pageOptions>
  <div
    class="flex  sm:flex-wrap sm:flex-row-reverse  items-center  gap-4 md:gap-6  mb-6"
...
<div class="relative w-48 filter-select border rounded-md bg-grey-50/80 cursor-pointer text-sm font-semibold text-teal-800  ">
    ...
    <div class="flex  items-center w-full  gap-4 ">
        ...
        <button
        @click="exportToExcel"
        class="export-btn whitespace-nowrap w-full   p-4 border rounded-md font-semibold text-sm text-teal-800 hover:bg-teal-50 transition-all duration-200"
      >
        Export
      </button>
    </div>
