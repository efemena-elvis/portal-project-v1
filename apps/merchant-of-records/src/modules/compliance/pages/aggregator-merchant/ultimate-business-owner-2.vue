...
const isActionReady = computed(() => {
  return merchantDataComputed.value.every((item) => {
    ...
    const validations = [
      validateRequired(ubo2.legal_full_name),
      validateRequired(ubo2.country_id),
      validateRequired(ubo2.address),
      validateRequired(ubo2.doc_type),
      validateRequired(ubo2.doc_url),
    ];
