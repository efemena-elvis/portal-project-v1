...
export const exportXLSX = (rows: Record<string, any>[], filename: string, sheetName = 'Sheet1') => {
...
export const safeExport = (rows: Record<string, any>[], filename: string, sheetName = 'Sheet1') => {
  try {
