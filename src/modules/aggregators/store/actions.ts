...
export const getSingleAggregator = async (id: string) => {
  return await $api.fetch(`${aggregatorRoutes.getSingleAggregator}/${id}`)
}
...
export const loginAggregatorAccount = async (id: string) => {
  return await $api.push(`${aggregatorRoutes.loginAggregatorAccount}/${id}/login`)
}

export const deleteAggregator = async (id: string) => {
  return await $api.delete(`${aggregatorRoutes.deleteAggregator}/${id}`)
}
